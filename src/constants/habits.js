...
export const SOCIAL_HABITS = [
  { id: "appeler", label: "Appeler ami/famille", emoji: "📞", xp: 10 },
  { id: "jeux", label: "Soirée jeux", emoji: "🎲", xp: 10 },
  { id: "sortie", label: "Sortie sociale", emoji: "👥", xp: 10 },
];

export const SOCIAL_WEEKLY = [
  { id: "dimanche_libre", label: "Dimanche libre", emoji: "🌴", xp: 20, weekly: true },
];
